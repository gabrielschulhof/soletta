...
var client = {
	server: soletta.sol_coap_server_new( defaultAddress ),
	dtls_server: soletta.sol_coap_secure_server_new( defaultAddress )
};
testUtils.assert( "ok", !!client.server, messagePrefix + "sol_coap_server_new() successful" );
